...
# UAT Configuration
$Global:UATConfig = @{
    SiteUrl         = "https://companynet.sharepoint.com/sites/Solutions-UAT/vaap"
    TargetListGuids = @(
...
# Prod Configuration
$Global:ProdConfig = @{
    SiteUrl         = "https://companynet.sharepoint.com/sites/solutions/vaap"
    TargetListGuids = @(
...
$Global:DevConfig = @{
    SiteUrl         = "https://companynet.sharepoint.com/sites/solutions-dev/vaap"
    TargetListGuids = @(
